...
class SlidePuzzle:
    def __init__(self, gs, ts, ms, screen):
        ...
        self.pic = pygame.transform.smoothscale(
            pygame.image.load(pathlib.Path("assets") / pathlib.Path("image.png")),
            self.rect.size,
        )
    ...
    def drawShortcuts(self, is_player, qValues):
        ...
        self.drawText("Pause: Escape", TXT_CORE_SIZE, 500, 70, 255, 255, 255, False)
        if is_player:
            self.drawText("Move up: <z>", TXT_CORE_SIZE, 500, 100, 255, 255, 255, False)
            self.drawText(
            ...
            self.drawText(
                "AI move: <Space>", TXT_CORE_SIZE, 500, 100, 255, 255, 255, False
            )
            self.drawText(
                    ...
                    if event.key == pygame.K_y:
                        ...
                        if onlyfiles != []:
                            if len(onlyfiles) < 36:
                                return str(
                                    model_name
                                    / pathlib.Path(f"QTable_{sorted_models[-1]+1}.txt")
                                )
                            else:
    ...
    def drawNonExistingModel(self):
        ...
        self.screen.fill((0, 0, 0))
        self.drawText(
            "There is not saved AI.", TXT_MENU_SIZE, 400, 150, 255, 255, 255, True
        )
        self.drawText(
            "Press <m> to go to the menu.", TXT_MENU_SIZE, 400, 250, 255, 255, 255, True
        )
        pygame.display.flip()
        while True:
            # Catch events.
    ...
    def pauseMenu(self):
        ...
        self.drawText("Press <y> for yes", TXT_MENU_SIZE, 400, 250, 255, 255, 255, True)
        self.drawText(
    ...
    def drawExitMenuAI(self):
        ...
        self.drawText("Congratulations !", TXT_MENU_SIZE, 250, 160, 0, 0, 0, True)
        self.drawText(
            "Moves : {}".format(self.nb_move),
            TXT_CORE_SIZE,
            500,
        ...
        self.drawText("Menu : <m>", TXT_CORE_SIZE, 500, 130, 255, 255, 255, False)
        self.drawText("Quit : <n>", TXT_CORE_SIZE, 500, 160, 255, 255, 255, False)
    ...
    def drawExitMenuHuman(self):
        ...
        self.drawText("Shortcuts", TXT_CORE_SIZE, 500, 40, 255, 255, 255, False)
        self.drawText("Restart : <y>", TXT_CORE_SIZE, 500, 70, 255, 255, 255, False)
    ...
    def exitMenu(self, is_AI):
        ...
        self.pic = pygame.transform.smoothscale(
            pygame.image.load(pathlib.Path("assets") / pathlib.Path("bluredImage.png")),
            self.rect.size,
        )
